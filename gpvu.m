function [logLoss, s2, tt] = gpvu(method, dataName, nLatentDims, useFeatures, gpScale, seed, Ytrain, Ytest, Xm, Xu)
    % e.g. exptPrefLearnSushi('npcaEp', 'sushi3b', 0, 1, 1);
    % e.g. exptPrefLearnSushi('ppcaEp', 'sushi3b', 0, 1, 1);
    % e.g. exptPrefLearnSushi('npcaJak', 'sushi3b', 0, 1, 1);
